...
<button class="tablinks" onclick="unrolltab(event,'Julia1')">Julia</button>
::: {#R1 .tabcontent}
#### {-}
<br>
```{r , eval = FALSE}
...
::: {.tab}
<button class="tablinks" onclick="unrolltab(event,'JAGS1')">JAGS</button>
<button class="tablinks" onclick="unrolltab(event,'NIMBLE1')">NIMBLE</button>
<button class="tablinks" onclick="unrolltab(event,'Stan1')">Stan</button>
<button class="tablinks" onclick="unrolltab(event,'Greta1')">Greta</button>
::: {#JAGS1 .tabcontent}
#### {-}
<br>
```{r ,eval = FALSE}
